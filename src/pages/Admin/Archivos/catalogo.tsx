...
const catalogo = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/files/catalogo`, formData)
