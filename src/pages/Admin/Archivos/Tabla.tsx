        ...
        <div className='w-full overflow-x-auto'>
          <table className='w-full'>
            ...
            <tbody>
              {data.map((item, key) => (
                <tr key={key}>
                  <td className='p-2 font-medium text-nowrap'>{item.title}</td>
                  <td className='p-2'>
                    {item.category === 1 ? 'Catálogo' : item.category === 2 ? 'Listado de precios' : ''}
                  </td>
